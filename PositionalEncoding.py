...
class PositionalEncoding(nn.Module):
    def __init__(self, d_model, max_seq_length):
        """
        d_model : depth of model (dimensions of embedding...) it must be even
        ...
        # as mentioned in paper, learnable PE and fixed PE performed almost similar, so making it fixed
        # buffer will make it part of the model's state_dict but these parameters will not be learnable
